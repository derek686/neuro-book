...
2. 检查 `agent-context/simulator.leader/context.md`、`agent-context/rp.writer/context.md`、`simulation/subjects/`、`simulation/entities/`、`simulation/runs/` 是否存在；缺失时优先从默认 Project 模板补齐。
