...
// ─── Settings DTOs ───────────────────────────────────────────────
import {
    AgentProfileModelSettingsDtoSchema,
    AgentToolSettingsDtoSchema,
    ...
    ModelSettingsDtoSchema,
    UpdateAgentProfileModelSettingsRequestDtoSchema,
    UpdateAgentToolSettingsRequestDtoSchema,
    UpdateModelSettingsRequestDtoSchema,
...
export const routeMetaMap: RouteMetaEntry[] = [
    ...
    // ═══ Settings ═══
    {
        file: "settings/agent-tools.get.ts",
        method: "get",
        tags: ["Settings"],
        summary: "Get agent tool allow/deny lists",
        responseBody: AgentToolSettingsDtoSchema,
    },
    {
        file: "settings/agent-tools.put.ts",
        method: "put",
        tags: ["Settings"],
        summary: "Update agent tool allow/deny lists",
        requestBody: UpdateAgentToolSettingsRequestDtoSchema,
        responseBody: AgentToolSettingsDtoSchema,
    },
    {
        file: "settings/models.get.ts",
        method: "get",
        tags: ["Settings"],
        summary: "Get model provider settings",
        responseBody: ModelSettingsDtoSchema,
    },
    {
        file: "settings/models.put.ts",
        method: "put",
        tags: ["Settings"],
        summary: "Update model provider settings",
        requestBody: UpdateModelSettingsRequestDtoSchema,
        responseBody: ModelSettingsDtoSchema,
    },
    {
        file: "settings/agent-profile-models.get.ts",
        method: "get",
        tags: ["Settings"],
        summary: "Get agent profile model assignments",
        responseBody: AgentProfileModelSettingsDtoSchema,
    },
    {
        file: "settings/agent-profile-models.put.ts",
        method: "put",
        tags: ["Settings"],
        summary: "Update agent profile model assignments",
        requestBody: UpdateAgentProfileModelSettingsRequestDtoSchema,
        responseBody: AgentProfileModelSettingsDtoSchema,
    },
    {
        file: "settings/models/model-check.post.ts",
        method: "post",
        tags: ["Settings"],
    ...
    {
        file: "settings/models/provider-check.post.ts",
        method: "post",
        tags: ["Settings"],
    ...
    {
        file: "settings/models/provider-discover.post.ts",
        method: "post",
        tags: ["Settings"],
